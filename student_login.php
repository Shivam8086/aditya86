...
if(isset($_REQUEST["submit"]))
{
  ...
  if($data = mysqli_fetch_array($res))
  {
    ...
    $_SESSION["student_course"] = $data["course"];
    // print_r($data);
    echo "<script>window.location.assign('student_dashboard.php')</script>";
  }
  else{
    echo "<script>window.location.assign('student_login.php?msg=Invalid credentails')</script>";
  }
}
?>