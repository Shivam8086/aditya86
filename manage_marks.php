...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Manage Marks</h4>
            ...
            <div class="col-xl">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="basic-default-fullname" name="course">
                      ...
                      <form method="post">
                        <tbody>
                          <?php
                            $sno=1;
                            include("config.php");
                            $q = "SELECT `marks`.*,`course`.`course_name` FROM `marks`INNER JOIN `course` ON `course`.`id`=`marks`.`course` WHERE `marks`.`course`='$_GET[course]'";
